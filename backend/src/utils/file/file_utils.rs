...
use shared::utils::{API_PROXY_FILE, CONFIG_FILE, CONFIG_PATH, MAPPING_FILE, SOURCE_FILE, USER_FILE, VOD_FILE};
use log::{debug, error};
...
#[inline]
pub fn get_default_vod_file_path(config_path: &str) -> String {
    get_default_file_path(config_path, VOD_FILE)
}

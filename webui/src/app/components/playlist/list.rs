...
use crate::app::components::{AppIcon, CollapsePanel, InputTable, PlaylistContext, PlaylistPage, TargetTable, TextButton};
...
pub fn PlaylistList() -> Html {
    ...
    let handle_create = {
        ...
        Callback::from(move |_| {
            playlist_ctx.active_page.set(PlaylistPage::Create);
        })
    };
